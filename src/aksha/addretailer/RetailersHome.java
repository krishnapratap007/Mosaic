...
import aksha.addmandi.AddMandi;
import aksha.addmandi.MandiList;
...
public class RetailersHome extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		mRoot = inflater.inflate(R.layout.retailershome, null);
		
		mTabHost = (FragmentTabHost)mRoot.findViewById(android.R.id.tabhost);
		mTabHost.setup(getActivity(),getChildFragmentManager(), R.id.realtabcontent);

		mTabHost.addTab(mTabHost.newTabSpec("0").setIndicator("Add Retailer"),
				AddRetailer.class, null);
		
		mTabHost.addTab(mTabHost.newTabSpec("1").setIndicator("My Retailers"),
				MyRetailers.class, null);
