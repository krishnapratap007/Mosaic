...
public class UpcomingDemoHome extends Fragment {
	private View mRoot;
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		mTabHost.addTab(mTabHost.newTabSpec("0").setIndicator("Create Demo"),
				CreateDemo.class, null);
		
		
		mTabHost.addTab(mTabHost.newTabSpec("1").setIndicator("Manage Demo"),
				ManageDemo.class, null);
