...
public class ActivityListAdapterFarmer extends BaseAdapter {
   ...
   public ActivityListAdapterFarmer(Context context,ArrayList<HashMap<String, String>> category, RefreshableListView mListView) {
