...
public class PlannedActivitiesGridViewAdapter extends BaseAdapter {
   ...
   public PlannedActivitiesGridViewAdapter(Context context,ArrayList<ArrayList<HashMap<String, String>>> category, RefreshableListView mListView, ArrayList<String> date2) {
     ...
     //    SimpleDateFormat stringdate = new SimpleDateFormat("M/dd/yyyy HH:mm:ss aa");
       ...
       //  Helper.getListViewSize(holder.gv);
         ...
         for (HashMap<String, String> hashMap : song) {
        	 if(hashMap.get("retailer").length()>0){
        		 LayoutInflater inf = (LayoutInflater)context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            	 View vew =inf.inflate(R.layout.activitylistitemfa, null);
                 ...
                 TextView village   		=	(TextView)vew.findViewById(R.id.villagename);
                 TextView remarks   		=	(TextView)vew.findViewById(R.id.village);
                 Spinner sp					=	(Spinner)vew.findViewById(R.id.spedit);
                ...
                /* SimpleDateFormat stringdate1 = new SimpleDateFormat("M/dd/yyyy");
                 String seldate = hashMap.get("plan_date");
              ...
              /*   
                 ...
                 if(hashMap.get("planstatus").equalsIgnoreCase("1")){
                	 datelayout.setBackgroundColor(Color.parseColor("#27ae60"));
                	 //count++;
                 }
                 else if(hashMap.get("planstatus").equalsIgnoreCase("2")){
                ...
                /* SimpleDateFormat stringdate = new SimpleDateFormat("dd MMM yyyy EEEE");
                 String dtm = hashMap.get("plandate");
                 try{								
                	 //09 Mar 2015 Monday
                	 Date dt = stringdate.parse(dtm);
                	 dtm = new SimpleDateFormat("d,MMM yyyy").format(dt);
                 ...
                 vew.setTag(hashMap);
                 name.setText(hashMap.get("retailer"));
                 email.setText(hashMap.get("jobdesc"));
                 address.setText("District- "+hashMap.get("districtid"));
                 mobile.setText("Mandi- "+hashMap.get("mandi"));
                 try{
                	 if(hashMap.get("villname").length()>0)
                     {
                    	 village.setText("Village- "+hashMap.get("villname"));
                     }
                     else
                     {
