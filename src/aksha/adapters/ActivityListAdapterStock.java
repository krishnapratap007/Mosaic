...
public class ActivityListAdapterStock extends BaseAdapter {
  ...
  String distid;
  String mandid;
   public ActivityListAdapterStock(Context context,ArrayList<HashMap<String, String>> category, RefreshableListView mListView,String distid,String mandid) {
   ...
   HashMap<String, String> song = new HashMap<String, String>();
    ...
    class Stockupdate extends AsyncTask<String, Void, String>{
    	...
    	protected void onPostExecute(String result) {    		
    		pDialog.dismiss();
    		new GetStocks().execute(distid,mandid);
    	}
				...
				String selectionargdup = "firm_id,firm_name,mobile,qnty,updatedate";
				 ...
				 ArrayList<String> inputlist = new ArrayList<String>();
					...
					inputlist.add(params[1]);
				     ...
				     String resultdata=wsc.MobileWebservice(context, "getstock",inputlist);
		...
		protected void onPostExecute(ArrayList<HashMap<String, String>> result) {
			...
			try{
				if(result!=null && result.size()>0){
	 				ActivityListAdapterStock adapter = new ActivityListAdapterStock(context, result, mLiView,distid,mandid);
