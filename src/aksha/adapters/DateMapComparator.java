...
public class DateMapComparator implements Comparator<Map<String, String>>{
    ...
    public int compare(Map<String, String> first,
        ...
        try{                              
        SimpleDateFormat df4 = new SimpleDateFormat("dd/MM/yy");    
         formattedDate3 = df4.parse(firstValue);
         SimpleDateFormat df5 = new SimpleDateFormat("dd/MM/yy");    
