...
import aksha.adapters.MOTabsPagerAdapter;
...
public class MOHomeScreen extends FragmentActivity implements
...
//***************** Tabs Initialize ***********************************
	...
	private MOTabsPagerAdapter mAdapter;

	private String [] tabs = {"Activity Planning","Tasks","My Retailers","My Farmers","Stock","Report"};	
...
mAdapter = new MOTabsPagerAdapter(getApplicationContext(),getSupportFragmentManager(),tabs.length);
...
mDrawerListright.setOnItemClickListener(new OnItemClickListener() {
	...
	public void onItemClick(AdapterView<?> arg0, View arg1, int position, long arg3) {
		...
		if(position==0)
		{
			 AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(MOHomeScreen.this);
			 ...
			 if(cd1.isConnectingToInternet()){
				...
				ArrayList<HashMap<String, String>> login = get.getAllLogin();
				 ...
				 File fdb=	getDatabasePath( "/data/data/"
		    	            + MOHomeScreen.this.getApplicationContext().getPackageName()
