...
public class FarmerHome extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		/*mTabHost.addTab(mTabHost.newTabSpec("0").setIndicator("Add Farmer"),
				Farmer.class, null);*/

		
		mTabHost.addTab(mTabHost.newTabSpec("0").setIndicator("Verified Farmer"),
				MyFarmer.class, null);
		
		mTabHost.addTab(mTabHost.newTabSpec("1").setIndicator("Farmer Added"),
				MyFarmerAdded.class, null);
		
		mTabHost.addTab(mTabHost.newTabSpec("2").setIndicator("Search"),
				SearchFarmer.class, null);
