...
public class AlarmReceiver extends WakefulBroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {   
    	...
    	if(new ConnectionDetector(context).isConnectingToInternet()){
    		...
    		Log.e("Intent service onReceive:", e.getMessage());
    	}
    }
    ...
    //    alarmMgr.setInexactRepeating(AlarmManager.RTC_WAKEUP,0, AlarmManager.INTERVAL_DAY, alarmIntent);
       //after 13.88 ohour
        alarmMgr.setInexactRepeating(AlarmManager.ELAPSED_REALTIME_WAKEUP,SystemClock.elapsedRealtime()+50000000,300000 , alarmIntent);
